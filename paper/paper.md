...
| PackageName        | Repository                                                                                              | Description                                                                                                                                                                                                            |
| :----------------- | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cite<br />@pyutil  | [GitHub Repo 1](https://github.com/tpltnt/pyutil)<br />[GitHub Repo 2](https://github.com/zooko/pyutil) | a library of useful Python functions and classes                                                                                                                                                                       |
| Cite<br />@Fu_PyHelpers_2020 | [GitHub Repo](https://github.com/mikeqfu/pyhelpers)                                                     | An open-source toolkit for facilitating Python<br />users' data manipulation tasks                                                                                                                                     |
| Cite<br />@psutil            | [GitHub Repo](https://github.com/giampaolo/psutil)                                                      | Cross-platform lib for process and system monitoring in Python                                                                                                                                                         |
| Cite<br />@pyutilator        | [GitHub Repo](https://github.com/antoprince001/pyutilator)                                              | open source python package comprising of decorators<br /> that can be used for utility operations                                                                                                                      |
| Cite<br />@pyutils           | [GitHub Repo](https://github.com/scottgasch/pyutils)                                                    | Python utilities                                                                                                                                                                                                       |
| Cite<br />@common-pyutil     | [GitHub Repo](https://github.com/akshaybadola/common-pyutil)                                            | Bunch of common utility functions I've used in various projects.<br />This package provides a uniform interface to them.                                                                                               |
| Cite<br />@pyutl             | [GitHub Repo](https://github.com/Jesrat/pyutl)                                                          | functions and utilities to recycle code                                                                                                                                                                                |
| Cite<br />@pyutilities       | [GitHub Repo](https://github.com/dmitry-ed-gusev/pyutilities)                                           | Useful utilities for python 3.10+                                                                                                                                                                                      |
| Cite<br />@dry-pyutils       | [GitHub Repo](https://github.com/monthero/dry-pyutils)                                                  | This package's goal is to offer a set of utility methods<br />I end up using in a lot of projects.                                                                                                                     |
| Cite<br />@pripy-utils       | [GitHub Repo](https://github.com/linjonh/pripy-utils)                                                   | Python utilities                                                                                                                                                                                                       |
| Cite<br />@imutils           | [GitHub Repo](https://github.com/PyImageSearch/imutils)                                                 | A series of convenience functions to make basic image<br />processing operations such as translation, rotation, resizing, <br />skeletonization, and displaying Matplotlib images easier with <br />OpenCV and Python. |
| Cite<br />@dateutil          | [GitHub Repo](https://github.com/dateutil/dateutil)                                                     | Useful extensions to the standard Python datetime features                                                                                                                                                             |
| Cite<br />@nb_utils          | [GitHub Repo](https://github.com/Nivratti/nb_utils)                                                     | python utility functions                                                                                                                                                                                               |
| Cite<br />@Python-Charmers   | [GitHub Repo](https://github.com/iwasakishuto/Python-Charmers)                                          | A collection of useful python programs.                                                                                                                                                                                |
| Cite<br />@python-in-action  | [GitHub Repo](https://github.com/Nevergiveupp/python-in-action)                                         | python crawler in action                                                                                                                                                                                               |
| Cite<br />@tbm13-utils       | [GitHub Repo](https://github.com/TBM13/tbm13-utils)                                                     | Python utils made for personal use on my projects.                                                                                                                                                                     |
| ...                | ...                                                                                                     | ...                                                                                                                                                                                                                    |
